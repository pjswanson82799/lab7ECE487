...
//queries the user to enter an char.  This int will be the n-wway set associative mapping for this iteration of the Simulator
...
int numberofCMblks(int sizeofCache, int sizeofBlock){
  int temp = sizeofCache/sizeofBlock;
  return temp;
}
...
//Calculated the number of bits required for tag.  Input is an int and output is also an int
...
void hit_miss(int mmblk[], int cmset[], int cmblk[], int minrange[], int maxrange[], int validbit[], int size){
}
